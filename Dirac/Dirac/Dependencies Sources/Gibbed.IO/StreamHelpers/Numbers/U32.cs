...
namespace Gibbed.IO
{
    public static partial class StreamHelpers
    {
        ...
        {
            return stream.ReadUInt32(Endian.Little);
        }
        ...
        {
            return stream.ReadUInt32(littleEndian == true ? Endian.Little : Endian.Big);
        }
        ...
        {
            stream.WriteUInt32(value, littleEndian == true ? Endian.Little : Endian.Big);
        }
        #endregion
    }
}
