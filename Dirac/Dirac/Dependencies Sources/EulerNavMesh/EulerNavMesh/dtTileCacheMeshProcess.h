...
{
public ref class dtTileCacheMeshProcessM
{
private:
	dtTileCacheMeshProcess *CLRObj;

public:
  dtTileCacheMeshProcessM()
  {
	  CLRObj = new dtTileCacheMeshProcess();
  }
  ~dtTileCacheMeshProcessM()
  {
	  delete CLRObj;
...
public ref class dtNavMeshCreateParamsM
{
private:
	dtNavMeshCreateParams *CLRObj;

public:
  dtNavMeshCreateParamsM()
  {
	  CLRObj = new dtNavMeshCreateParams();
  }
  ~dtNavMeshCreateParamsM()
  {
	  delete CLRObj;
