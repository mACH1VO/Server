...
namespace Dirac.Math.Collections
{
    ...
    public class QuaternionCollection : ICollection, IList, IEnumerable, ICloneable
    {
        ...
        #endregion Public helpers (just to mimic some nice features of ArrayList)
        ...
        private class Enumerator : IEnumerator, IQuaternionCollectionEnumerator
        {
            ...
            #endregion Operations (type-safe IEnumerator)

            #region Implementation (IEnumerator)

            object IEnumerator.Current { get { return (object)(this.Current); } }

            #endregion Implementation (IEnumerator)
        }

        #endregion Nested enumerator class
        ...
        private class SyncQuaternionCollection : QuaternionCollection
        {
            ...
            #endregion Type-safe ICollection
            ...
            #endregion Type-safe IEnumerable
        ...
        #endregion Nested Syncronized Wrapper class
        ...
        #endregion Nested Read Only Wrapper class
    }
}