...
namespace Dirac.Logging
{
    ...
    /// </summary>
    public sealed class WindowLogConfig : Config.Config
    {
        ...
        /// </summary>
        public WindowLogConfig() :
            base("WindowLogConfig") // Call the base ctor with section name 'Logging'.
        { }

        /// <summary>
        /// Singleton instance.
        /// </summary>
        public static WindowLogConfig Instance { get { return _instance; } }

        /// <summary>
        /// The internal instance pointer.
        /// </summary>
        private static readonly WindowLogConfig _instance = new WindowLogConfig();
    }
}
