...
namespace Dirac.Math
{
    ...
    public struct Vector3
    {
        ...
        public bool IsInvalid { get { return float.IsNaN(this.x) || float.IsNaN(this.y) || float.IsNaN(this.z); } }
        ...
        /// </summary>
        public float Length { get { return Utility.Sqrt(this.x * this.x + this.y * this.y + this.z * this.z); } }
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "Vector3({0}, {1}, {2})", ((float)this.x).ToString("0.00"), ((float)this.y).ToString("0.00"), ((float)this.z).ToString("0.00"));
        }
