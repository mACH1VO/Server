...
namespace Dirac.Logging
{
    ...
    /// </summary>
    public class WindowTarget : LogTarget
    {
        /// <summary>
        ...
        public WindowTarget(Logger.Level minLevel, Logger.Level maxLevel, bool includeTimeStamps)
        {
        ...
        private static void _setConsoleForegroundColor(Logger.Level level)
        {
            switch (level)
            {
