...
namespace Dirac.Logging
{
    ...
    /// </summary>
    public sealed class PacketLogConfig : Config.Config
    {
        ...
        public PacketLogConfig() :
            base("PacketLogConfig") // Call the base ctor with section name 'Logging'.
        { }

        /// <summary>
        /// Singleton instance.
        /// </summary>
        public static PacketLogConfig Instance { get { return _instance; } }

        /// <summary>
        /// The internal instance pointer.
        /// </summary>
        private static readonly PacketLogConfig _instance = new PacketLogConfig();
    }
}
