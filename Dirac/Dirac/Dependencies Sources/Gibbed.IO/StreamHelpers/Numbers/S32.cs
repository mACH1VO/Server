...
namespace Gibbed.IO
{
    public static partial class StreamHelpers
    {
        ...
        {
            return stream.ReadInt32(Endian.Little);
        }
        ...
        {
            return stream.ReadInt32(littleEndian == true ? Endian.Little : Endian.Big);
        }
        ...
        {
            stream.WriteInt32(value, littleEndian == true ? Endian.Little : Endian.Big);
        }
        #endregion
    }
}
