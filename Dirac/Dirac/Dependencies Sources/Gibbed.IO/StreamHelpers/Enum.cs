    ...
    public static partial class StreamHelpers
    {
        ...
        public static T ReadValueEnum<T>(this Stream stream, Endian endian)
        {
            ...
            switch (EnumTypeCache.Get(type))
            {
                ...
                case TypeCode.Int16:
                {
                    value = stream.ReadInt16(endian);
                    break;
                }

                case TypeCode.UInt16:
                {
                    value = stream.ReadUInt16(endian);
                    break;
                }

                case TypeCode.Int32:
                {
                    value = stream.ReadInt32(endian);
                    break;
                }
                ...
                case TypeCode.Int64:
                {
                    value = stream.ReadInt64(endian);
                    break;
                }

                case TypeCode.UInt64:
                {
                    value = stream.ReadUInt64(endian);
                    break;
                }
        ...
        public static void WriteValueEnum<T>(this Stream stream, object value, Endian endian)
        {
            ...
            switch (EnumTypeCache.Get(type))
            {
                ...
                case TypeCode.Int16:
                {
                    stream.WriteInt16((short)value, endian);
                    break;
                }

                case TypeCode.UInt16:
                {
                    stream.WriteUInt16((ushort)value, endian);
                    break;
                }

                case TypeCode.Int32:
                {
                    stream.WriteInt32((int)value, endian);
                    break;
                }

                case TypeCode.UInt32:
                {
                    stream.WriteUInt32((uint)value, endian);
                    break;
                }

                case TypeCode.Int64:
                {
                    stream.WriteInt64((long)value, endian);
                    break;
                }

                case TypeCode.UInt64:
                {
                    stream.WriteUInt64((ulong)value, endian);
                    break;
                }
