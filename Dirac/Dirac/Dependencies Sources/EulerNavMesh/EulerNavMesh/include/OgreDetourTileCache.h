...
#include "RecastContrib/fastlz.h"
...
public:
    ...
    /**
      ...
      **/
    inline float getTileSize(void) { return m_tileSize*m_cellSize; }
...
// TODO maybe also add a unloadAllTilesExcept(boundingBox) method
    ...
    /**
      * Gets grid coordinates of the tile that contains the specified world position.
      **/
    //Ogre::Vector2 getTileAtPos(const Vector3 pos);
    ...
    bool saveAll(const char* path, const dtNavMesh* mesh);
    ...
    /**
      ...
      **/
    //dtObstacleRef addTempObstacle(Vector3 pos);
    ...
    /**
      ...
      **/
   //dtObstacleRef removeTempObstacle(Vector3 raySource, Vector3 rayHit);
    ...
    /**
      ...
      * box area.
      **/
    //std::vector<dtCompressedTileRef> getTilesContainingBox(Vector3 boxMin, Vector3 boxMax);
    ...
    /**
      ...
      **/
    //std::vector<dtCompressedTileRef> getTilesAroundPoint(Vector3 point, float radius);
...
//TODO by adding deferred tasking to add and removeConvexShapeObstacle one can add multiple shapes at once to the same tile without it being rebuilt multiple times
    ...
    /**
      ...
      * If removedObstacle is a valid pointer it will contain a reference to the removed obstacle.
      **/
    //int removeConvexShapeObstacle(Vector3 raySource, Vector3 rayHit, ConvexVolume** removedObstacle = NULL);
    ...
    /**
      ...
      **/
    //int hitTestConvexShapeObstacle(Vector3 raySource, Vector3 rayHit);
...
protected:
    ...
    /**
      ...
      **/
    void drawPolyMesh(const int tileName, const struct dtTileCachePolyMesh &mesh, const float *orig, const float cs, const float ch, const struct dtTileCacheLayer &regionLayers, bool colorRegions=true);
