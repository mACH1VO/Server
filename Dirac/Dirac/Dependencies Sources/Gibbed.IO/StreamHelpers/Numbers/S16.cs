...
namespace Gibbed.IO
{
    public static partial class StreamHelpers
    {
        ...
        {
            return stream.ReadInt16(Endian.Little);
        }
        ...
        {
            return stream.ReadInt16(littleEndian == true ? Endian.Little : Endian.Big);
        }
        ...
        {
            stream.WriteInt16(value, littleEndian == true ? Endian.Little : Endian.Big);
        }
        #endregion
    }
}
