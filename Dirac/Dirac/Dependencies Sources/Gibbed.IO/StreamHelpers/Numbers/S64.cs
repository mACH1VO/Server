...
namespace Gibbed.IO
{
    public static partial class StreamHelpers
    {
        ...
        {
            return stream.ReadInt64(Endian.Little);
        }
        ...
        {
            return stream.ReadInt64(littleEndian == true ? Endian.Little : Endian.Big);
        }
        ...
        {
            stream.WriteInt64(value, littleEndian == true ? Endian.Little : Endian.Big);
        }
        #endregion
    }
}
