...
namespace Gibbed.IO
{
    public static partial class StreamHelpers
    {
        ...
        {
            var a = stream.ReadInt32(endian);
            var b = stream.ReadInt16(endian);
            var c = stream.ReadInt16(endian);
        ...
        public static void WriteValueGuid(this Stream stream, Guid value, Endian endian)
        {
            ...
            stream.WriteInt32(BitConverter.ToInt32(data, 0), endian);
            stream.WriteInt16(BitConverter.ToInt16(data, 4), endian);
            stream.WriteInt16(BitConverter.ToInt16(data, 6), endian);
