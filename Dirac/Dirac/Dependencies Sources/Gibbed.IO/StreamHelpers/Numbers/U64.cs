...
namespace Gibbed.IO
{
    public static partial class StreamHelpers
    {
        ...
        {
            return stream.ReadUInt64(Endian.Little);
        }
        ...
        {
            return stream.ReadUInt64(littleEndian == true ? Endian.Little : Endian.Big);
        }
        ...
        {
            stream.WriteUInt64(value, littleEndian == true ? Endian.Little : Endian.Big);
        }
        #endregion
    }
}
