...
class NSLabel : Control
{
    ...
    public NSLabel()
    {
        ...
        _B1 = new SolidBrush(Color.FromArgb(205, 150, 0));
    }
    ...
    public System.Drawing.Color B1
    {
        get { return this._B1.Color; }
        set
        {
            this._B1.Color = value;
        }
    }
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        G.DrawString(Value2, Font, _B1, PT2);
    }
...
class NSRandomPool : Control
{
    ...
    private int ItemSize = 29;

    private int DrawSize = 28;
    ...
    private void UpdateTable()
    {
        ...
        {
            //Table[I] = Convert.ToByte(RNG.Next(10));
            Table[I] = Convert.ToByte(200);
        }
    ...
    private void HandleDraw2(MouseEventArgs e)
    {
        if (e.Button == System.Windows.Forms.MouseButtons.Left || e.Button == System.Windows.Forms.MouseButtons.Right)
        {
            if (!WA.Contains(e.Location))
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int I = 0; I <= Table.Length - 1; I++)
        {
            //int C = Math.Max(Table[I], (byte)255);
            int C = Table[I];
    ...
    private void Randomize(int index, int color)
    {
        ...
        if (index > -1 && index < Table.Length)
        {
            if (InvertColors)
            {
                Table[index] = Convert.ToByte(color);
            }
            else
            {
                Table[index] = Convert.ToByte(color);
