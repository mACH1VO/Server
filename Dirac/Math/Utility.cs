...
namespace Dirac.Math
{
    public sealed class Utility
    {
        ...
        {
            // machivo trick: Ok, this needs to be looked at.  The decimal precision of float values can sometimes be
        ...
        /// <summary>
        ///    Returns a random Color between 0 0 0 and 255 255 255.
        /// </summary>
        ...
        {
            int a = (int)((255) * UnitRandom() + 0);
            int r = (int)((255) * UnitRandom() + 0);
            int g = (int)((255) * UnitRandom() + 0);
            int b = (int)((255) * UnitRandom() + 0);
